  ...
  theme: {
    extend: {
      ...
      fontSize: {
        ...
        'small-meta': ['0.875rem', { lineHeight: '1.5', letterSpacing: '0.01em' }],
        'button': ['0.9375rem', { lineHeight: '1', letterSpacing: '0.02em' }],
        'body-regular': ['1.0625rem', { lineHeight: '1.65', letterSpacing: '0' }],
        'body-large': ['1.1875rem', { lineHeight: '1.65', letterSpacing: '0' }],
        'h4': ['1.125rem', { lineHeight: '1.45', letterSpacing: '0' }],
        'card-h3': ['1.5rem', { lineHeight: '1.35', letterSpacing: '-0.01em' }],
        'section-h2': ['clamp(1.875rem, 3.5vw, 2.75rem)', { lineHeight: '1.25', letterSpacing: '-0.015em' }],
        'hero-h1': ['clamp(2.25rem, 5vw, 3.5rem)', { lineHeight: '1.18', letterSpacing: '-0.02em' }],
      },
      spacing: {
        '1': '4px',
        '2': '8px',
