          ...
          <div className="lg:col-span-7">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 sm:gap-6">
              {trustValue.pillars.map((pillar) => (
                <div
                  key={pillar.id}
                  className="group p-6 sm:p-7 rounded-lg bg-surface border border-border-subtle shadow-card hover:border-action-primary/40 hover:shadow-card-hover transition-all duration-200 flex flex-col justify-start"
                >
                  {/* Icon Emblem */}
